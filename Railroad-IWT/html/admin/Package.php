...
<div class="well">
        <table>
            ...
            <h3 class="empal">PACKAGE INFO</h3>
            <!--search-->
            <!-- <div>
...
?>
                    ...
                    <table>
                        ...
                        <td><a href="updatepackage.php?pid=<?php echo $row["pid"]; ?>">Update</a>
                        <a href="deletePackage.php?pid=<?php echo $row["pid"]; ?>">Delete</a></td>
                          </tr>
                          <?php
                          $i++;
                          }
                    ...
                    <?php
                      ...
                      ?>
<button class="btncreate">  <a style="text-decoration:none; color:white;" href="addPackage.html"> Add</a>
