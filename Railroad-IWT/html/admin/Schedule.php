  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      ...
      <li ><a href="../adminhome.php">Dashboard</a></li>
        <li class="active"><a href="#">Shedule</a></li>
...
?>
                    ...
                    <table>
                        ...
                        <td><a href="updateshedule.php?tid=<?php echo $row["tid"]; ?>">Update</a>
                        <a href="deleteshedule.php?tid=<?php echo $row["tid"]; ?>">Delete</a></td>
                          </tr>
                          <?php
                          $i++;
                          }
                    ...
                    <?php
                      ...
                      ?>
<button class="btncreate">  <a style="text-decoration:none; color:white;" href="addshedule.html"> Add</a>
